            ...
            <div className="row mt-5">
                ...
                <div className="col-9">
                    <div className="tab-content" id="v-pills-tabContent">
                        <div className="w3-animate-right tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab"><BaiTapGiay /></div>
                        <div className="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab"><BaiTapModal /></div>
                        <div className="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab"><BaiTapDienThoai></BaiTapDienThoai></div>
                    </div>
                </div>
            </div>
