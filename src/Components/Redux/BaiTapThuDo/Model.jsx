    ...
    render() {
        ...
        return (
            <div className="contain">
                <div className="body" />
                <div className="model" />
                <div className="hairstyle" style={{ background: `url(${hairstyle})` }} />
                <div className="necklace" style={{ background: `url(${necklaces})` }} />
                <div className="bikinitop" style={{ background: `url(${topclothes})` }} />
                <div className="bikinibottom" style={{ background: `url(${botclothes})` }} />
                <div className="handbag" style={{ background: `url(${handbags})` }} />
                <div className="feet" style={{
